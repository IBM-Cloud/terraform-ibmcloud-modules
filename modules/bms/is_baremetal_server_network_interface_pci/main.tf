resource "shell_script" "is_baremetal_server_network_interface_pci" {
  lifecycle_commands {
...
variable "bm_server_network_interface_vlan" { default = "" }
...
output "output" {
  value = shell_script.is_baremetal_server_network_interface_pci.output
}
